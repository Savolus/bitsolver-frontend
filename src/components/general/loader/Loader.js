...
export default ({ white, small }) => {
  const [ color ] = useState(white ? '#fff' : "#0B51C6")
  ...
  return (
    <div className='loader'>
      <svg xmlns="http://www.w3.org/2000/svg" style={style} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" display="block">
